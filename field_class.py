...
class Field:
    """Simulate a field the can contain animals and crops"""
...
def display_crop_menu():
    ...
    print("2. Wheat")
    print()
    print("0. I don't want to add a crop - return to the main menu")
    print()
...
def display_animal_menu():
    ...
    print("2. Sheep")
    print()
    print("0. I don't want to add an animal - return to the main menu")
    print()
    print("Please select an option from the above menu")
